  ...
  return (
    <div className="app-shell">
      ...
      <div className="main-area">
        ...
        {section === 'issues' && <IssuesView project={currentProject} currentUser={session} onOpenIssue={openIssue} onNewIssue={() => setShowNewIssue(true)} onStatusChange={(issueId, status) => updateIssueField(issueId, 'status', status, '状态')} onBatchStatusChange={updateIssueStatuses} />}
